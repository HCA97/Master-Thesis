...
# # img_size = (3, 64, 128)
# # generator_params = {"n_layers": 4, "init_channels": 512, "padding_mode": "reflect", "kernel_size": 3, "inject_noise": True, "use_spectral_norm": True,
# #                     "bn_mode": "default", "act": "leakyrelu", "last_layer_kernel_size": 3}
# # discriminator_params = {"base_channels": 64, "n_layers": 5, "heat_map": False,
...
# # net = StyleGan(img_size, **generator_params).cuda()
# # z = th.ones((10, 100)).cuda()
# # print(net)
# # x = net(z)
# # print(x.shape)
# # print(summary(net, (100, 1, 1)))
