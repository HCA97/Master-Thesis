...
class ImageFolder(Dataset):
    ...
    def __init__(self, root, root2="", transform=None, transform2=None):
...
class PostdamCarsDataModule(LightningModule):
    ...
    def __init__(self, data_dir: str, data_dir2: str = "", img_size: Tuple[int, int] = (32, 64), batch_size: int = 64, transform=None, transform2=None):
        super().__init__()
    ...
    def setup(self, state=None):
        ...
        self.dataset = ImageFolder(
            self.data_dir1, root2=self.data_dir2, transform=self.transform1, transform2=self.transform2)
