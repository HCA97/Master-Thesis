...
gammas = [1e-3, 1e-2, 1e-1, 0.5, 1, 5, 10]
...
results_dir = "/scratch/s7hialtu/dcgan_symmetry_loss"
...
for gamma in gammas:
    for batch_size in batch_sizes:
        model = GAN(img_dim, discriminator_params=discriminator_params, fid_interval=interval,
                    generator_params=generator_params, gen_model="basic", gamma=gamma, use_symmetry_loss=True)
