...
results_dir = "/scratch/s7hialtu/pix2pix_u_net_patch_type_1"
...
for discriminator_param in discriminator_params:
    for generator_param in generator_params:
        model = GAN(img_dim, discriminator_params=discriminator_param, fid_interval=interval, disc_model="patch",
