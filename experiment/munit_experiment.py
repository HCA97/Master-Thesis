...
results_dir = "/scratch/s7hialtu/munit_experiments"
...
for transform1, transform2 in transforms_:
    # using Recommended parameters as https://github.com/NVlabs/imaginaire/tree/master/projects/munit and paper
    model = MUNIT(img_dim,
