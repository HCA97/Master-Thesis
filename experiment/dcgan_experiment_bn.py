...
# POTSDAM CARS
generator_params = {"n_layers": 4, "init_channels": 512, "bn_mode": "default"}

discriminator_params = [{"base_channels": 32, "n_layers": 4, "bn_mode": "old"},
                        {"base_channels": 32, "n_layers": 4,
                            "use_bn_first_conv": True, "bn_mode": "old"},
                        {"base_channels": 32, "n_layers": 4, "bn_mode": "default"},
                        {"base_channels": 32, "n_layers": 4,
                            "use_bn_first_conv": True, "bn_mode": "default"}
                        ]
...
results_dir = "/scratch/s7hialtu/dcgan_bn"
